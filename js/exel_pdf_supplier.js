...
document.getElementById('exportExcel').addEventListener('click', function() {
    ...
    for (var cellAddress in ws) {
        if (ws.hasOwnProperty(cellAddress) && cellAddress[0] !== '!') {
            ...
            // Hapus data NaN/waktu  kolom pertama
    ...
    // Nama judul Ekspor ke Excel
    XLSX.writeFile(wb, 'Data Supplier.xlsx');
 });
 ...
 document.getElementById('exportPdf').addEventListener('click', function() {
    ...
    const subtitle = 'DATA TABEL SUPPLIER';
    ...
    console.log("Rows Data:", rows);
        ...
        // Nama judul Ekspor ke PDF
        doc.save('Data Supplier.pdf');
    });
